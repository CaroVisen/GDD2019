...
using Kofba.Framework.Translation;

public partial class VEstado : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            gvwEvaluations.Columns.FromKey("Estado").IsGroupByColumn = true;
            gvwEvaluations.Columns.FromKey("Tipo Variable").Width = Unit.Pixel(190);
            gvwEvaluations.Columns.FromKey("Evaluado").Width = Unit.Pixel(190);
            gvwEvaluations.Columns.FromKey("Evaluador").Width = Unit.Pixel(190);
            ...
            gvwEvaluations.Columns.FromKey("Mail").Width = Unit.Pixel(190);
