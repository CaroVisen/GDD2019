...
public partial class UI_ManagementIndicatorsAdmin : System.Web.UI.UserControl, IManagementIndicators
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //}
        LoadManagementIndicatorsAdmin();
    }


    private void LoadManagementIndicatorsAdmin()
    {
		...
		Tabla_Mensajes_Jefes.Visible = ( groupId == 7 );
        MImsg.Visible = (groupId != 7);
		string filtro = "%";
		...
		SqlDataReader myReader = SQLHelper.ExecuteReader( Cache["ApplicationDatabase"].ToString( ) , "[GetManagementIndicatorsAdmin]" , new object[] { groupId , username , profile , filtro } );
