<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ManagementIndicatorsAdmin.ascx.cs" Inherits="UI_ManagementIndicatorsAdmin" %>
        <asp:Table ID="MImsg" Width="100%" BorderColor="#9F0004" BorderStyle="Dotted" BorderWidth="2" CellSpacing="0" CellPadding="5" runat="server"> 
            <asp:TableRow >
                <asp:TableCell CssClass="msg">
                    ...
                    Las calificaciones que surjen de los <i>“Resultados obtenidos”</i> (para este grupo), “<u>NO tienen peso en la Evaluación</u>”, es decir, no influyen en el resultado final de la Gestión del Desempeño.
                    </span>
                </asp:TableCell>
            </asp:TableRow>
        </asp:Table>
