...
public partial class VGerencia : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
		...
		if( !Page.IsPostBack )
		{
			...
			gvwEvaluations.DataSource = SQLHelper.ExecuteDataset( HttpContext.Current.Cache["ApplicationDatabase"].ToString( ) , "GetEvaluationsManagementViews" , new object[] { txtbuscar.Text , filtro_local , filtro_direccion } );
			gvwEvaluations.DataBind( );
			gvwEvaluations.Columns.FromKey( "Direccion" ).IsGroupByColumn = true;
			gvwEvaluations.Columns.FromKey( "Gerencia" ).IsGroupByColumn = true;
