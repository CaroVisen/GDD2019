...
public partial class VEvaluado : System.Web.UI.Page
{
    ...
    protected void gvwEvaluations_DBlClick(object sender, ClickEventArgs e)
    {
        ...
        {
            Response.Redirect(Server.HtmlEncode("./EvaluationFormLink.aspx?.=" + Server.UrlEncode(Encryption.Encrypt(groupid + ".1." + evaluador))));
        }
    }
